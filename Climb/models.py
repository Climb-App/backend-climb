...
class Reward(models.Model):
    ...
    icon = models.ImageField( upload_to="icon/reward", blank=True )
...
class Badge(models.Model):
    name = models.CharField( max_length=100 )
    description = models.TextField()
    icon = models.ImageField( upload_to="icon/badge", blank=True )
...
class TeamUser(models.Model):
    ...
    multiplicator_id = models.ForeignKey( Multiplicator, on_delete=models.CASCADE, related_name="team_users_mult" )
...
class Task(models.Model):
    ...
    goal_id = models.ForeignKey( Goal, on_delete=models.CASCADE, related_name="tasks_goal" )
    team_user_id = models.ForeignKey( TeamUser, on_delete=models.CASCADE, related_name="tasks_team_user" )
    created_at = models.DateTimeField(auto_now_add=True)
